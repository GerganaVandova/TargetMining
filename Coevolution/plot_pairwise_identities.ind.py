...
def plot_identities(targets, colors, ks_pair_identities, target_pair_identities, qtarget):
    ...
    for target in ks_pair_identities:
        ...
        if target == qtarget:
            ...
            print "ks_pair identities", ks_pair_identities
            ...
            plt.xlim([0, 100])
            plt.ylim([0, 100])
            figname = "plots/92.5kb." + qtarget + ".png"
            plt.savefig(figname, dpi=400)


def main():

    # "#000000" is black, have to remove it from colors
    colors = [
    ...
    targets1 = ['sp_P17109_MEND_ECOLI', 'sp_P0A6K3_DEF_ECOLI', 'mfR6_squalene_synthase',
                'sp_P16659_SYP_ECOLI', 'sp_P05041_PABB_ECOLI', 'sp_P0A8M3_SYT_ECOLI',
                'sp_P0A6W3_MRAY_ECOLI', 'sp_P0A7Z4_RPOA_ECOLI', 'sp_P60785_LEPA_ECOLI']
