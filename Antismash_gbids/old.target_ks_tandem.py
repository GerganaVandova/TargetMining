...
def main():
    ...
    f1 = open("KS.92.50kb.lpxc.fasta", "w")
    f2 = open("targets.92.50kb.lpxc.fasta", "w")
    f3 = open("out.92.filtered.50kb.lpxc", "w")
    f4 = open("out.92.filtered.50kb.lpxc.noks", "w")
    ...
    for line in target_blasts:
        ...
        if target_name != "sp_P0A725_LPXC_ECOLI": # added for debugging purposes
            continue
