...
filename <- "KS.119.10kb.fasta.cdhit.90.withFabF.mafft.FastTree"
...
filename2 <- "KS.119.10kb.fasta.descr"
...
filename1 <- "KS.119.10kb.fasta.filtered.target"
...
dir1 <- "/Users/gvandova/Dropbox/Computational_projects/TargetMiningGenomes/Phylogeny/"
filename1 <- "KS.119.10kb.fasta.filtered.phyla" # to get colors by phyla for KSs
...
outfile <- paste(dir, filename, ".png", sep="")
title <- "KS.119.10kb"
