...
def get_fasta_filtered(fastafile, outfile):
...
def main():
    ...
    get_fasta_filtered("../Antismash_gbids/KS.609.5kb.fasta", "KS.609.5kb.fasta.filtered")
    get_fasta_filtered("../Antismash_gbids/KS.609.10kb.fasta", "KS.609.10kb.fasta.filtered")
    get_fasta_filtered("../Antismash_gbids/targets.609.5kb.fasta", "targets.609.5kb.fasta.filtered")
    get_fasta_filtered("../Antismash_gbids/targets.609.10kb.fasta", "targets.609.10kb.fasta.filtered")
