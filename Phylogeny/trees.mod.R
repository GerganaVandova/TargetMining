...
# reorder descriptions
desc.reordered <- desc.df[rownames(tip.label.df),]# This is the key step that matches
#the tree tip names to the external description file
# Assign targets to variables
