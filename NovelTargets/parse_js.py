...
def main():
    count = 0
    # antismash_dir = "../Antismash_gbids/antismash_output/"
    antismash_dir = "../Antismash_gbids/antismash_output_assemblies_all/"

    outfile_cluster_genes = "cluster_gene_names.89k.fasta"
    #outfile_cluster_genes = "cluster_genes.21k.fasta"
    gene_out_f = open(outfile_cluster_genes, "w")

    outfile_ks = "ks_names.89k.fasta"
    ...
    for gbidfull in tqdm.tqdm(os.listdir(antismash_dir)):
        if not gbidfull.startswith("LQPQ01000178"):
            continue
